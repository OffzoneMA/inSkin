...
function Newpassword({ navigation }) {
  ...
  return (
        ...
        <View >
          ...
          >
            {({
              ...
              <>
                <ScrollView>
                <Text style={style.label}>Your New Password</Text>
    ...
    marginTop: 20,
    opacity:  values.newPassword && values.newPasswordConfirmation ? 1 : 0.5,
  ...
  disabled={ !values.newPasswordConfirmation ||!values.newPassword || Object.keys(errors).length !== 0}>
                       Confirm
                    </Button>
